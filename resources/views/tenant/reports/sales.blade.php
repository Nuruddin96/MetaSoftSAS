...
<div class="grid grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
    <x-ui.card><p class="text-mute text-xs">মোট বিক্রি</p><p class="font-disp font-extrabold text-2xl mt-1">{{ number_format($revenue) }}৳</p></x-ui.card>
    <x-ui.card><p class="text-mute text-xs">অর্ডার সংখ্যা</p><p class="font-disp font-extrabold text-2xl mt-1">{{ $orders }}</p></x-ui.card>
    <x-ui.card><p class="text-mute text-xs">গড় অর্ডার</p><p class="font-disp font-extrabold text-2xl mt-1">{{ number_format($avg) }}৳</p></x-ui.card>
</div>
...
<div class="grid lg:grid-cols-2 gap-6">
    <x-ui.card padding="none">
        <div class="px-5 py-3.5 border-b border-ink/5 font-bold text-sm">দিনভিত্তিক বিক্রি</div>
        <div class="max-h-96 overflow-auto">
            ...
            @empty
                <p class="px-5 py-10 text-center text-mute text-sm">এই সময়ে কোনো বিক্রি নেই।</p>
            @endforelse
        </div>
    </x-ui.card>
    ...
    <div class="space-y-6">
        <x-ui.card padding="none">
            <div class="px-5 py-3.5 border-b border-ink/5 font-bold text-sm">স্ট্যাটাস অনুযায়ী</div>
        ...
        <x-ui.card padding="none">
            <div class="px-5 py-3.5 border-b border-ink/5 font-bold text-sm">সোর্স অনুযায়ী</div>
